...
1. Preserve 100% of the original meaning — do not add or remove facts.
2. Match this Voice DNA: {dna.model_dump_json()}
3. Add one natural reference to {dna.location}.
4. Use currency {dna.currency} if money is mentioned.
